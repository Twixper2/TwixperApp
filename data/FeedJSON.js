...
//COMMENTING the following code because its only porpoise is writing
...
exports.data = [
	{
		...
		quoted_status: {
			...
			user: {
				...
				location: "Manchester",
				description:
					"The official Manchester City Women match day account | Follow the women’s team beyond the game @ManCity | Supporter Services @ManCityHelp",
				url: null,
				entities: {
					description: {
						urls: [],
	...
	},
	{
		...
		user: {
			...
			description:
				"Just a scripted-line saying, game show playing, TV show talking, notebook hawking super blerd! ❤✊🏽 Wrote #AlwaysABridesmaid on @netflix",
	...
	},
	{
		...
		full_text:
			"RT @insider_reviews: 💰 New low: The @Fitbit Inspire 2 Activity Tracker is down to $70 at @target (originally $100) ➡️ https://t.co/briQK7nn…",
		truncated: false,
		...
		user: {
			...
			description:
				"What you want to know about tech. A division of @thisisinsider. Follow us on Facebook, Instagram, and YouTube. Visit our homepage for the day's top stories.",
		...
		retweeted_status: {
			...
			user: {
				...
				description:
					"Honest reviews of products and services. A division of @thisisinsider. When you buy through our links, we may earn money from our affiliate partners.",
	...
	},
	{
		...
		full_text:
			"עוד טעימה מהפרוייקט-אם גם אתם התעוררתם באמצע הלילה אני ממליץ לכם לתת מבט. עכשיו ההתלבטות היא האם להישאר ער עוד קצת ולראות את הדראפט של ים..\n@Madar2020 https://t.co/bJpEzPJmUP",
		truncated: false,
		...
		user: {
			...
			location: "",
			description:
				"4th year student of BSc in Software and Information Systems Engineering in BGU.\nCheck out my Senior Project @TwixperApp .\nHTA fan (well, nobody's perfect).",
	...
	},
	{
		...
		full_text:
			"It is true. @RealMerrinD blazed trails! ❤️ I watched her on television LONG before I started acting and we’re peers. She got in young and is STILL killing the game. \n\nShe WORKS! Ya hear me?! She WORKS! ❤️\n\n👏🏾👏🏾👏🏾👏🏾👏🏾👏🏾👏🏾👏🏾👏🏾 https://t.co/zH873x9ZEJ",
		truncated: false,
		...
		user: {
			...
			location: "Fiddling with your mind",
			description:
				"Just a scripted-line saying, game show playing, TV show talking, notebook hawking super blerd! #StayWoke ❤✊🏽 #AlwaysABridesmaid on @netflix",
	...
	},
	{
		...
		full_text:
			"🔄 A second change as we approach the final 10 minutes — @Donny_Beek6 is on for @B_Fernandes8!\n\n🔴 #MUFC\n#️⃣ #SHUMUN\n🏆 #PL https://t.co/wUAbWrtGs9",
		truncated: false,
		display_text_range: [0, 120],
		entities: {
			hashtags: [
	...
	},
	{
		...
		full_text:
			"ביום רביעי הבא נניח הצעה לפיזור הכנסת. לא עוד שבועיים, לא עוד חודש, לא עוד 45 יום, יום רביעי הבא תונח על שולחן הכנסת הצעה לפיזור הכנסת. אם עד אז לא יעבור תקציב אין לי ספק, שהפעם אנשי כחול לבן יעמדו במילתם, יצביעו איתנו, נפזר את הכנסת, נשלח את הממשלה האיומה הביתה ונלך לבחירות. https://t.co/pqxZjsg2lr",
		truncated: false,
